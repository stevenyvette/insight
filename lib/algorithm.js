...
function POCC(count){
    ...
    option_pocc = {
/*    	title:{
    		subtext:"POCC: property oriented clustering coefficient\nCC: clustering coefficient",
    		itemGap:0,
    		top:0px,	
    	},*/
        tooltip: {
...
function ReplaceProbability(v,r,count){
    ...
    if(p>=top_three['top']){
    	top_three['third']=v;
    	top_three['second']=top_three['top'];
    	top_three['top']=p;
    }else if(p>=top_three['second']){
    	top_three['third']=top_three['second'];
    	top_three['second']=p;
    }else if(p>=top_three['third']){
    	top_three['third']=p;
    }else{
    	console.log('else');
    }
